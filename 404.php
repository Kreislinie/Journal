		...
		<main id="main" class="site-main">
			...
			<section class="error-404 not-found">
				...
				<div class="page-content">
					<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'bitjournal' ); ?></p>
					...
					<div class="widget widget_categories">
						<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'bitjournal' ); ?></h2>
						<ul>
							<?php
